ChordQuality.create!(:name => 'Majeur', :code => 'MAJ').tap do |q|
  q.chords.create!(:name => 'Triade majeure', :specify_tones => "u 3 5").tap do |c|
  ...
  q.chords.create!(:name => 'Majeur 7', :specify_tones => "u 3 5 7").tap do |c|
  ...
  q.chords.create!(:name => 'Majeur 6', :specify_tones => "u 3 5 6").tap do |c|
...
ChordQuality.create!(:name => 'Mineur', :code => 'MIN').tap do |q|
  q.chords.create!(:name => 'Triade mineure', :specify_tones => "u m3 5").tap do |c|
  ...
  q.chords.create!(:name => 'Mineur septième', :specify_tones => "u m3 5 ♭7").tap do |c|
  ...
  q.chords.create!(:name => 'Mineur 6', :specify_tones => "u ♭3 5 6").tap do |c|
  ...
  q.chords.create!(:name => 'Phrygien', :specify_tones => "u ♭2 ♭3 5 ♭6").tap do |c|
  ...
  q.chords.create!(:name => 'Mineur septième majeure', :specify_tones => "u ♭3 5 7").tap do |c|
...
ChordQuality.create!(:name => 'Septième de dominante', :code => 'DOM').tap do |q|
  q.chords.create!(:name => 'Septième de dominante', :specify_tones => "u 3 5 ♭7").tap do |c|
    ...
    c.children.create!(:chord_quality => q, :name => '7 ♯5', :specify_tones => "u 3 ♯5 ♭7").tap do |cc|
    ...
    c.children.create!(:chord_quality => q, :name => '7 sus', :specify_tones => "u 4 5 ♭7").tap do |cc|
...
ChordQuality.create!(:name => 'Diminué', :code => 'DIM').tap do |q|
  q.chords.create!(:name => 'Triade diminuée', :specify_tones => "u ♭3 ♭5").tap do |c|
  ...
  q.chords.create!(:name => 'Demi-diminué', :specify_tones => "u ♭3 ♭5 ♭7").tap do |c|
  ...
  q.chords.create!(:name => 'Diminué', :specify_tones => "u ♭3 ♭5 ♭7").tap do |c|
    c.symbols.create!(:name => '°7', :primary => true)
    c.symbols.create!(:name => '°')
    c.symbols.create!(:name => 'dim7')
...
ChordQuality.create!(:name => 'Augmenté', :code => 'DIM').tap do |q|
  q.chords.create!(:name => 'Triade augmentée', :specify_tones => "u 3 ♯5").tap do |c|
  ...
  q.chords.create!(:name => 'Augmenté septième majeure', :specify_tones => "u 3 ♯5 7").tap do |c|
